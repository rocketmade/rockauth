# ActiveAdmin.register Rockauth::Configuration.controller_mappings.first.safe_constantize.reflections['provider_authentications'].klass, as: "ProviderAuthentication" do
